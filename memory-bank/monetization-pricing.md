# Monetization and Pricing — Elena Verna / Reforge 
...
To identify value metric: ask "what does the customer get more of when they succeed with our product?". This is what they're actually paying for and this is what be used to normalize the price per unit they compare among vendors. 
...
Payback will differ by industry, marketing mix, company stage. It should be factored in your approach to finding signals and best-performing segments.
...
Use this to understand how will customers be guided through the upgrades ladder once they're ready to grow.
