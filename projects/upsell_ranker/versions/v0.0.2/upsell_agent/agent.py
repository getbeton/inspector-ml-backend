...
upsell_worker = Agent(
    ...
    instruction=(
        ...
        "\n"
        "Workflow step 0 (mandatory): read the founding-sales and\n"
        "monetization-pricing sections in the memory bank above before\n"
        "drafting the website summary. Cite the doc(s) you applied in\n"
        "the `assumptions` field of your output (short name + 1-line gist),\n"
        "e.g. 'founding-sales: anchored ICP to engineering-led teams'.\n"
        "\n"
        "Hard constraints:\n"
