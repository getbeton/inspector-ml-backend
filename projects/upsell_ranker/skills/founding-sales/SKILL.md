...
Match a company with your ICP by answering:

- **Who has the pain?** — Specific titles and functional roles, not just companies.
- **Budget authority** — Can this person spend money on the problem without multi-level approval?
- **Organization size threshold** — Below a certain size, the pain isn't worth formalizing with tooling. Find the minimum.
